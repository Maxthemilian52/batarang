    ...
    return (
        ...
        return (
            ...
            <div className="d-flex justify-content-between header1">
                ...
                <div >
                    <a href='www.facebook.com'><img className="icon" src={Facebook} alt="Facebook"></img></a>
                    <a href='www.twitter.com'><img className="icon" src={Twitter} alt="Twitter"></img></a>
                    <a href='www.instagram.com'><img className="icon" src={Instagram} alt="Instagram"></img></a>
                </div>
            </div>
            <div className="d-flex justify-content-around header2 align-items-center">
                <div>
